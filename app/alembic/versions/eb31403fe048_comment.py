...
Revision ID: eb31403fe048
Revises: 3dbcb3480955
Create Date: 2023-02-27 12:00:28.903494
...
revision = 'eb31403fe048'
down_revision = '3dbcb3480955'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('image_title'),
    schema='dev'
    )
...
def downgrade() -> None:
    ...
    op.drop_table('user_profile_images', schema='dev')
    # ### end Alembic commands ###
